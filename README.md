# Journal de bord – TPI
**Projet :** GIRARD-SiteWeb  
**Candidat :** Tido Kaze Samuel  
**Maître de classe :** M. Girard
...
- Créer la page de connexion et d'inscription (tâche 3.1.2)
- Implémenter l'inscription et la connexion côté backend (tâche 3.2.1)
...
- Créer la page administrateur 
- Implémenter la recherche d'annonces
- Commencer le CSS # Journal de bord – TPI
**Projet :** GIRARD-SiteWeb  
**Candidat :** Tido Kaze Samuel  
**Maître de classe :** M. Girard
